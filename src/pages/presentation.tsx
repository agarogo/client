...
export default function Presentation() {
    const slides = [
        {
            custom: (
                <div className="flex flex-col items-center justify-center h-full text-center px-6 res w-full text-black">
                    <h1 className="text-6xl mon mb-6 mt-[-20%]">Ленский мост</h1>
    ...
    return (
        <section className="h-[80vh] w-[90vw] mx-auto my-5 bg-white rounded-[32px] relative overflow-hidden flex flex-col justify-center items-center">
            {slides[current].custom ? (
                slides[current].custom
            ) : (
                <div className="text-center px-6">
                    <h2 className="text-4xl mon mb-4">{slides[current].title}</h2>
                    <p className="whitespace-pre-line text-lg text-[#0A1044]">{slides[current].content}</p>
                </div>
            )}
